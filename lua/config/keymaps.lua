...
-- ==                         CUSTOM KEYMAPPINGS                           == --
-- ========================================================================== --
--  The following keymappings have been heavily inspired by the LazyVim
--    keymaps.  With some of my own personal modifications
-- better up/down
...
-- Lazy way of opening lazy plugin manager
